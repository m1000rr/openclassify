            ...
            <div class="p-6">
                ...
                <div class="mt-3 flex flex-wrap items-center gap-2">
                    ...
                    <form method="POST" action="{{ route('favorites.sellers.toggle', $listing->user) }}">
                        ...
                        @if($detailConversation?->id)
                        <a href="{{ route('panel.inbox.index', ['conversation' => $detailConversation->id]) }}" class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-rose-100 text-rose-700 hover:bg-rose-200 transition">
                            Open chat
                        </a>
                        @else
