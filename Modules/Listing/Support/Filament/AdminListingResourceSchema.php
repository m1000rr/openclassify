...
class AdminListingResourceSchema
{
    ...
    {
        return [
            TextInput::make('title')->required()->maxLength(255)->live(onBlur: true)->afterStateUpdated(fn ($state, $set, $livewire) => $livewire instanceof \Filament\Resources\Pages\CreateRecord ? $set('slug', \Illuminate\Support\Str::slug($state).'-'.\Illuminate\Support\Str::random(4)) : null),
