...
class ListingController extends Controller
{
    ...
    {
        $isOwner = auth()->check() && (int) auth()->id() === (int) $listing->user_id;

        abort_unless($listing->isPubliclyVisible() || $isOwner, 404);
        ...
        $listing->loadMissing([
            ...
            'category.parent.parent.parent:id,name,parent_id,slug',
            'category.parent.parent.parent.parent:id,name,parent_id,slug',
