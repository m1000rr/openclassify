...
final class DemoSchemaManager
{
    ...
    public function activateForProcessing(string $schema, ?string $uuid = null): void
    {
    ...
    public function cleanupExpired(): int
    {
        ...
        foreach ($expired as $instance) {
            DemoStoragePath::purgeForUuid($instance->uuid);
    ...
    public function clearDemoArtifacts(?string $uuid): void
    {
        ...
        DemoStoragePath::purgeForUuid($uuid);
    ...
    private function activateSchema(string $schema, ?string $uuid = null): void
    {
        config([
            ...
            'demo.active_schema' => $schema !== (string) config('demo.public_schema', 'public') ? $schema : null,
            'demo.active_uuid' => $uuid,
            'cache.prefix' => $uuid
